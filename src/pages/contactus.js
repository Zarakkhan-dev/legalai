    ...
    <div className="grid grid-cols-4 text-gray-800 lg:grid-cols-3">
      <div className="col-span-4 bg-gray-50 px-8 py-10 text-gray-800 md:col-span-2 md:border-r md:px-10 md:py-12 lg:col-span-1">
        ...
        <ul>
          <li className="mb-6 flex items-start text-left">
            ...
            <div>
              <a className="cursor-pointer  text-base md:text-lg" href="#">zarakkhan1031@gmail.com</a>
          ...
          <li className="my-6 flex items-center text-left">
            ...
            <div>
              <a className="cursor-pointer  text-base md:text-lg" href="#">Zarak Khan</a>
          ...
          <li className="my-6 flex items-center text-left">
            ...
            <div>
              <p className="text-base md:text-lg">ZARAK KHAN</p>
      ...
      <div className="order-first col-span-4 max-w-screen-md px-8 py-10 md:order-last md:col-span-2 md:px-10 md:py-12">
        ...
        <form action="">
          ...
          <span>         <button type="submit" className="group flex cursor-pointer items-center rounded-xl bg-blue-600 bg-none px-8 py-4 text-center font-semibold leading-tight text-white">
            Send
